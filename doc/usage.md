...
[latest Ferrite Core](https://ferrite.org) (2.0.0+)
and [latest Electrum-FEC wallet](https://ferritecoin.org/) (3.2+).
...
Allow Ferrite daemon to sync before starting Electrum server:
```bash
